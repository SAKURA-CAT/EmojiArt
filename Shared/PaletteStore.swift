...
//        UserDefaults.standard.set(palettes.map({[$0.name, $0.emojis, $0.id]}), forKey: userDefaultKey)
    ...
    private func restoreFromUserDefaults(){
        ...
        // use custom save func
//        if let paletteAsPropertyList = UserDefaults.standard.array(forKey: userDefaultKey) as? [[String]]{
...
//        }
    ...
    init(named name:String){
        ...
        if palettes.isEmpty{
            ...
            print("use UserDefault in cache: \(palettes)")
        }
    }
    ...
    // remove a palette, if the index is in the range of [0, palettes.count)
    ...
    // add the new palette into palettes
    // add in front of the palettes default
